...
@Schema(name = "ApplePay_allOf", description = "Apple Pay source.")
@JsonTypeName("ApplePay_allOf")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2022-10-07T17:34:59.232080700+07:00[Asia/Bangkok]")
public class ApplePayAllOf {
  ...
  public ApplePayAllOf data(String data) {
    this.data = data;
    return this;
  }
  ...
  */
  ...
  public ApplePayAllOf header(AppleHeader header) {
    this.header = header;
    return this;
  }
  ...
  */
  ...
  public ApplePayAllOf signature(String signature) {
  ...
  */
  ...
  public ApplePayAllOf version(String version) {
  ...
  */
  ...
  public ApplePayAllOf applicationData(String applicationData) {
  ...
  */
  ...
  public ApplePayAllOf applePayMerchantId(String applePayMerchantId) {
  ...
  */
  ...
  public ApplePayAllOf merchantPrivateKey(String merchantPrivateKey) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    ApplePayAllOf applePayAllOf = (ApplePayAllOf) o;
    return Objects.equals(this.data, applePayAllOf.data) &&
        Objects.equals(this.header, applePayAllOf.header) &&
        Objects.equals(this.signature, applePayAllOf.signature) &&
        Objects.equals(this.version, applePayAllOf.version) &&
        Objects.equals(this.applicationData, applePayAllOf.applicationData) &&
        Objects.equals(this.applePayMerchantId, applePayAllOf.applePayMerchantId) &&
        Objects.equals(this.merchantPrivateKey, applePayAllOf.merchantPrivateKey);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, header, signature, version, applicationData, applePayMerchantId, merchantPrivateKey);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ApplePayAllOf {\n");
